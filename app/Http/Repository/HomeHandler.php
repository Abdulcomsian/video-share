...
class HomeHandler{
    public function termAndConditionText(){
        ...
        These Terms of Service ("Terms") govern your use of the OpenEdit (the "Application") provided by OpenEdit.net, a NeoTec LLC ("we," "us," or "our"). By accessing or using the Application, you agree to comply with and be bound by these Terms. If you do not agree with these Terms, please refrain from using the Application.
        ...
        4.2 Payment: Payments for Freelancer services will be handled through Stripe. We are not responsible for any issues related to payment transactions.
        ...
        11. Governing Law
        These Terms are governed by the laws of Wyoming.

        By using the Application, you agree to these Terms. If you have any questions or concerns, please contact us at support@openedit.net.';
    }
