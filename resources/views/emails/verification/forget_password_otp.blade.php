...
<body>
    <div class="container">
        <div class="header">
            <h1>Forget Password Otp Verification</h1>
        </div>
        <div class="content">
        ...
        <div class="footer">
            <p>If you did not request a password reset, please ignore this email or contact us at {{ config('variables.supportEmail')}}</p>
        </div>
    </div>
</body>
</html>
